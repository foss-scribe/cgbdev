...
description: "Created as part of Canva's job application process to demonstrate my skills in API documentation, Swagger and JavaScript"
---
...
![Final HTML page](/img/examples/swagger_petstore/list.png)
